    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            $this->publishes([
                ...
                __DIR__ . '/../../database/migrations/create_user_credits_transactions_table.php.stub' => database_path('migrations/' . date('Y_m_d_His', time()) . '_create_wplus_user_transactions_table.php'),
