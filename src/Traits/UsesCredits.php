<?php
namespace JohnMerrick\UserCredits\Traits;

use JohnMerrick\UserCredits\Models\UserCredit as Credit;
...
trait UsesCredits
{
    ...
    {
        return $this->hasOne('JohnMerrick\UserCredits\Models\UserCredit', 'user_id');
    }
